...
$registryUninstallerKeyName = '{F5210620-068F-49C4-8C49-61C3D1A11FDD}_is1' #The uninstall registry key for our application. Defined and setup by the installer exe.
